...
```{r}
reference=readLines("JulesVerne.txt")
...
ggplot(melt(trans.prob.mat),aes(Var2,Var1))+geom_tile(aes(fill=value))+
  ...
  labs(x="Probabilité de la seconde lettre",y="selon la première",fill="Probabilité")+
...
```{r}
correctTxt="Les Cheminées offraient une retraite suffisante provisoirement. Le
